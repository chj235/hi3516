...
# Hisilicon resize_crop sample makefile

# 编译所需的公共文件
include ./mk.param

# 编译后生成的可执行文件名
TARGET := ohos_resize_crop_demo

# 编译此工程需要依赖的.c或.cpp文件
SMP_SRCS += $(RESIZE_CROP_SAMPLE_DIR)/sample_resize_crop_main.c
SMP_SRCS += $(RESIZE_CROP_SAMPLE_DIR)/smp/smp_resize_crop.c
...
# 编译此工程需要包含的头文件
CFLAGS += -I$(RESIZE_CROP_SAMPLE_DIR)/smp
