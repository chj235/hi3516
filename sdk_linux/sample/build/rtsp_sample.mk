...
# Hisilicon rtsp sample makefile

# 编译所需的公共文件
include ./mk.param

# 编译后生成的可执行文件名
TARGET := ohos_rtsp_demo

# 编译此工程需要依赖的.c或.cpp文件
SMP_SRCS += $(RTSP_SAMPLE_DIR)/sample_comm_venc.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/sample_rtsp_main.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/ringfifo.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/rtputils.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/rtspservice.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/rtsputils.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/sample_comm_venc.c
SMP_SRCS += $(RTSP_SAMPLE_DIR)/smp/sample_rtsp.c
