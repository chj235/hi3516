...
/*****************************************************************************
*   Prototype    : HI_MPI_IVE_Query_Timeout
*   Description  : This API is used to query the status of a called function by using the returned
*                   IveHandle of the function. The system waits until it is timeout. It is never
*                   timeout when the s32MilliSec is -1.
*   Parameters   : IVE_HANDLE     IveHandle     IveHandle of a called function. It is entered by users.
*                   HI_S32        s32MilliSec    Wait time,millisecond
*                   HI_BOOL       *pbFinish      Returned status
*   Return Value : HI_SUCCESS: Success;Error codes: Failure.
*   Spec         :  None
*****************************************************************************/
