...
# Hisilicon color_space_convert sample makefile

# 编译所需的公共文件
include ./mk.param

# 编译后生成的可执行文件名
TARGET := ohos_color_space_convert_demo

# 编译此工程需要依赖的.c或.cpp文件
SMP_SRCS += $(COLOR_SAMPLE_DIR)/sample_color_space_convert_main.c
SMP_SRCS += $(COLOR_SAMPLE_DIR)/smp/smp_color_space_convert.c
