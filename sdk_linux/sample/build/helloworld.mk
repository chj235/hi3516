...
# Hisilicon helloworld sample makefile

# 编译所需的公共文件
include ./mk.param

# 编译后生成的可执行文件名
TARGET := ohos_helloworld_demo

# 编译此工程需要依赖的.c或.cpp文件
SMP_SRCS += $(HELLOWORLD_SAMPLE_DIR)/sample_lcd_main.c
SMP_SRCS += $(HELLOWORLD_SAMPLE_DIR)/smp/sample_lcd.c
...
# 编译此工程需要包含的头文件
CFLAGS += -I$(HELLOWORLD_SAMPLE_DIR)/smp
