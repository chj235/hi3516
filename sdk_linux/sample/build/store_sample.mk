...
# Hisilicon store sample makefile

# 编译所需的公共文件
include ./mk.param

# 编译后生成的可执行文件名
TARGET := ohos_store_demo

# 编译此工程需要依赖的.c或.cpp文件
SMP_SRCS += $(STORE_SAMPLE_DIR)/sample_store_main.c
SMP_SRCS += $(STORE_SAMPLE_DIR)/smp/sample_store.c
