...
#define HIFB_BOUNDARY_Y_RANGE  2
#define HIFB_BOUNDARY_CB_RANGE 2
#define HIFB_BOUNDARY_CR_RANGE 2
...
typedef struct {
    hi_u16 boundary_y[HIFB_BOUNDARY_Y_RANGE];
    hi_u16 boundary_cb[HIFB_BOUNDARY_CB_RANGE];
    hi_u16 boundary_cr[HIFB_BOUNDARY_CR_RANGE];
