...
typedef enum hiHDMI_BARINFO_E {
    ...
    HDMI_BAR_INFO_H,         /* Horizontal bar data valid */
    HDMI_BAR_INFO_VH         /* Horizontal and Vertical bar data valid */
} HI_HDMI_BARINFO_E;
...
typedef enum hiHDMI_PICTURE_SCALING_E {
    ...
    HDMI_PICTURE_SCALING_H,           /* Picture has been scaled horizontally */
    HDMI_PICTURE_SCALING_V,           /* Picture has been scaled Vertically */
    HDMI_PICTURE_SCALING_HV           /* Picture has been scaled Horizontally and Vertically */
...
typedef enum hiHDMI_EXT_COLORIMETRY_E {
    HDMI_COLORIMETRY_XVYCC_601,               /* Colorimetry xvYCC601 extended option */
    HDMI_COLORIMETRY_XVYCC_709,               /* Colorimetry xvYCC709 extended option */
    HDMI_COLORIMETRY_S_YCC_601,               /* Colorimetry S YCC 601 extended option */
    HDMI_COLORIMETRY_ADOBE_YCC_601,           /* Colorimetry ADOBE YCC 601 extended option */
    HDMI_COLORIMETRY_ADOBE_RGB,               /* Colorimetry ADOBE RGB extended option */
    HDMI_COLORIMETRY_2020_CONST_LUMINOUS,     /* Colorimetry ITU2020 extended option */
    HDMI_COLORIMETRY_2020_NON_CONST_LUMINOUS, /* Colorimetry ITU2020 extended option */
    HDMI_COLORIMETRY_RESERVED
} HI_HDMI_EXT_COLORIMETRY_E;

typedef enum hiHDMI_RGB_QUAN_RAGE_E {
    HDMI_RGB_QUANTIZATION_DEFAULT_RANGE, /* Default range, it depends on the video format */
...
typedef enum hiHDMI_PIXEL_REPETITION_E {
    HDMI_PIXEL_REPEAT_NO,
    HDMI_PIXEL_REPEAT_2_TIMES,
    HDMI_PIXEL_REPEAT_3_TIMES,
    HDMI_PIXEL_REPEAT_4_TIMES,
    HDMI_PIXEL_REPEAT_5_TIMES,
    HDMI_PIXEL_REPEAT_6_TIMES,
    HDMI_PIXEL_REPEAT_7_TIMES,
    HDMI_PIXEL_REPEAT_8_TIMES,
    HDMI_PIXEL_REPEAT_9_TIMES,
    HDMI_PIXEL_REPEAT_10_TIMES,
    HDMI_PIXEL_REPEAT_RESERVED_A,
    HDMI_PIXEL_REPEAT_RESERVED_B,
    HDMI_PIXEL_REPEAT_RESERVED_C,
    HDMI_PIXEL_REPEAT_RESERVED_D,
    HDMI_PIXEL_REPEAT_RESERVED_E,
    HDMI_PIXEL_REPEAT_RESERVED_F
...
typedef struct hiHDMI_AUDIO_INFO_S {
    ...
    /* Audio sample rate */
    HI_HDMI_SAMPLE_RATE_E enSupportSampleRate[HI_HDMI_MAX_SAMPLE_RATE_NUM];
...
typedef struct hiHDMI_TIMING_INFO_S {
    ...
    hi_u32 u32HFB;          /* horizontal front blank */
    hi_u32 u32HBB;          /* horizontal back blank */
    hi_u32 u32HACT;         /* horizontal active area */
    hi_u32 u32VPW;          /* vertical sync pulse width */
    hi_u32 u32HPW;          /* horizontal sync pulse width */
    hi_bool bIDV;           /* flag of data valid signal is needed flip */
    hi_bool bIHS;           /* flag of horizontal sync pulse is needed flip */
    hi_bool bIVS;           /* flag of vertical sync pulse is needed flip */
    ...
    hi_s32 u32PixelClk;     /* pixel clk for this timing, unit:KHz */
...
typedef struct hiHDMI_ATTR_S {
    ...
    hi_bool bAuthMode;
    /*
     * Enable flag of video mode & DVI adapting case of user setting incorrect, default:HI_TRUE.
 ...
 * is showing/has removed a menu and requests the remote control keys to be passed through.
 */
